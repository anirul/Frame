...
namespace frame {
	...
	EntityId LevelBase::AddSceneNode(
	...
	EntityId LevelBase::AddMaterial(
		const std::string& name,
	...
	EntityId LevelBase::AddStaticMesh(
		const std::string& name,
