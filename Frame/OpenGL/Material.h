...
/**
 * @class Material
 * @brief this is the support for material when rendering you need to have a material for each
 * mesh so that you know which program to run on each pixel (fragment shader mostly). For now this
 * is not saving a local copy of the level so you'll have to pass it through.
 */
class Material : public MaterialInterface {
   public:
    /**
     * @brief This is getting the program id from a level or from the local stored one.
     ...
     * @return Return the name and the binding slot of a texture (to be passed to the program).
     */
