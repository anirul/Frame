...
namespace frame::opengl {
	...
	const std::shared_ptr<StaticMeshInterface> SceneMatrix::GetLocalMesh() const
	{
		return nullptr;
	}
	...
	CameraInterface& SceneTree::GetDefaultCamera()
	{
	...
	const CameraInterface& SceneTree::GetDefaultCamera() const
	{
		auto ptr = GetSceneByName(camera_name_);
		if (ptr)
		{
	...
	const std::shared_ptr<StaticMeshInterface> SceneCamera::GetLocalMesh() const
	{
		return nullptr;
	}
	...
	const std::shared_ptr<StaticMeshInterface> SceneLight::GetLocalMesh() const
	{
		return nullptr;
	}
