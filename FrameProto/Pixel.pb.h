...
enum PixelElementSize_Enum : int {
  ...
  PixelElementSize_Enum_PixelElementSize_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  PixelElementSize_Enum_PixelElementSize_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
enum PixelStructure_Enum : int {
  ...
  PixelStructure_Enum_PixelStructure_Enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  PixelStructure_Enum_PixelStructure_Enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
class PixelElementSize PROTOBUF_FINAL :
 ...
 public:
  ...
  inline PixelElementSize* New() const final {
    return CreateMaybeMessage<PixelElementSize>(nullptr);
  }

  PixelElementSize* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
class PixelStructure PROTOBUF_FINAL :
 ...
 public:
  ...
  inline PixelStructure* New() const final {
    return CreateMaybeMessage<PixelStructure>(nullptr);
  }

  PixelStructure* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
...
inline ::frame::proto::PixelElementSize_Enum PixelElementSize::_internal_value() const {
  return static_cast< ::frame::proto::PixelElementSize_Enum >(value_);
}
...
inline ::frame::proto::PixelStructure_Enum PixelStructure::_internal_value() const {
  return static_cast< ::frame::proto::PixelStructure_Enum >(value_);
}
