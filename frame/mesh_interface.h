...
struct MeshParameter
{
    ...
    proto::NodeMesh::RenderPrimitiveEnum render_primitive_enum =
        proto::NodeMesh::TRIANGLE_PRIMITIVE;
    //! @brief The shadow effect type.
    proto::NodeMesh::ShadowEffectEnum shadow_effect_enum =
        proto::NodeMesh::OPAQUE_SHADOW_EFFECT;
    //! @brief what kind of buffer will be generated (no point of course).
    enum class MeshParameterEnum
    {
        GENERATE_COLOR,
        GENERATE_INDEX,
    ...
    std::set<MeshParameterEnum> generate_list = {};
};

/**
 * @class MeshInterface
 * @brief Mesh rendering interface.
 */
class MeshInterface : public Serialize<proto::NodeMesh>
{
  public:
