...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Program::set_shader_vertex(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* Program::mutable_shader_vertex() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Program::set_allocated_shader_vertex(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.shader_vertex_.IsDefault()) {
...
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Program::set_shader_fragment(Arg_&& arg,
                                                     Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline std::string* Program::mutable_shader_fragment() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void Program::set_allocated_shader_fragment(std::string* value) {
  ...
  if (::google::protobuf::internal::DebugHardenForceCopyDefaultString() && _impl_.shader_fragment_.IsDefault()) {
