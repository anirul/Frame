 ...
 * implemented if you want to port this to another rendering pipeline.
 */
class DeviceInterface {
 public:
  /**
   ...
   */
  virtual void Clear(const glm::vec4& color = glm::vec4(.2f, 0.f, .2f,
                                                        1.0f)) const = 0;
  /**
   ...
   * @param static_mesh_parameter: A struct containing the parameters to create
   * a static mesh.
