...
#ifndef GOOGLE_PROTOBUF_INCLUDED_program_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_program_2eproto_2epb_2eh
...
class SceneType final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:frame.proto.SceneType) */ {
 public:
  inline SceneType() : SceneType(nullptr) {}
  ~SceneType() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR SceneType(::google::protobuf::internal::ConstantInitialized);

  inline SceneType(const SceneType& from)
      : SceneType(nullptr, from) {}
  ...
  SceneType* New(::google::protobuf::Arena* arena = nullptr) const final {
...
class Program final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:frame.proto.Program) */ {
 public:
  ...
  inline Program(const Program& from)
      : Program(nullptr, from) {}
  ...
  void set_input_texture_names(int index, const char* value, std::size_t size);
  void set_input_texture_names(int index, absl::string_view value);
  ...
  void add_input_texture_names(const char* value, std::size_t size);
  void add_input_texture_names(absl::string_view value);
  ...
  void set_output_texture_names(int index, const char* value, std::size_t size);
  void set_output_texture_names(int index, absl::string_view value);
  ...
  void add_output_texture_names(const char* value, std::size_t size);
  void add_output_texture_names(absl::string_view value);
...
inline void Program::set_input_texture_names(int index, const std::string& value) {
  _internal_mutable_input_texture_names()->Mutable(index)->assign(value);
...
inline void Program::set_input_texture_names(int index, std::string&& value) {
  _internal_mutable_input_texture_names()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:frame.proto.Program.input_texture_names)
}
...
inline void Program::set_input_texture_names(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_input_texture_names()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:frame.proto.Program.input_texture_names)
}
inline void Program::set_input_texture_names(int index, absl::string_view value) {
  _internal_mutable_input_texture_names()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:frame.proto.Program.input_texture_names)
}
inline void Program::add_input_texture_names(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_input_texture_names()->Add()->assign(value);
...
inline void Program::add_input_texture_names(std::string&& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_input_texture_names()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:frame.proto.Program.input_texture_names)
}
...
inline void Program::add_input_texture_names(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_input_texture_names()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:frame.proto.Program.input_texture_names)
}
inline void Program::add_input_texture_names(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_input_texture_names()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:frame.proto.Program.input_texture_names)
}
...
inline void Program::set_output_texture_names(int index, const std::string& value) {
  _internal_mutable_output_texture_names()->Mutable(index)->assign(value);
...
inline void Program::set_output_texture_names(int index, std::string&& value) {
  _internal_mutable_output_texture_names()->Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:frame.proto.Program.output_texture_names)
}
...
inline void Program::set_output_texture_names(int index, const char* value,
                              std::size_t size) {
  _internal_mutable_output_texture_names()->Mutable(index)->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:frame.proto.Program.output_texture_names)
}
inline void Program::set_output_texture_names(int index, absl::string_view value) {
  _internal_mutable_output_texture_names()->Mutable(index)->assign(value.data(),
                                                     value.size());
  // @@protoc_insertion_point(field_set_string_piece:frame.proto.Program.output_texture_names)
}
inline void Program::add_output_texture_names(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_output_texture_names()->Add()->assign(value);
...
inline void Program::add_output_texture_names(std::string&& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_output_texture_names()->Add(std::move(value));
  // @@protoc_insertion_point(field_add:frame.proto.Program.output_texture_names)
}
...
inline void Program::add_output_texture_names(const char* value, std::size_t size) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_output_texture_names()->Add()->assign(
      reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:frame.proto.Program.output_texture_names)
}
inline void Program::add_output_texture_names(absl::string_view value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _internal_mutable_output_texture_names()->Add()->assign(value.data(), value.size());
  // @@protoc_insertion_point(field_add_string_piece:frame.proto.Program.output_texture_names)
}
inline const ::google::protobuf::RepeatedPtrField<std::string>&
...
inline ::frame::proto::SceneType* Program::_internal_mutable_input_scene_type() {
  ...
  if (_impl_.input_scene_type_ == nullptr) {
    auto* p = CreateMaybeMessage<::frame::proto::SceneType>(GetArena());
...
inline void Program::set_allocated_input_scene_type(::frame::proto::SceneType* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::frame::proto::SceneType*>(_impl_.input_scene_type_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::frame::proto::SceneType*>(value)->GetArena();
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_program_2eproto_2epb_2eh
