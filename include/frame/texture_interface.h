...
struct TextureParameter {
  ...
  //! @brief Texture data, in case you don't want to provide it just pass an
  //! empty vector. You have to multiply the size by the pixel element size to
  //! get the size of the vector.
  void* data_ptr = nullptr;
  //! @brief In case of cube map you need 6 planes of array pointers.
  std::array<void*, 6> array_data_ptr = {nullptr, nullptr, nullptr,
