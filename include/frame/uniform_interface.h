 ...
 * @brief Get access to essential part of the rendering uniform system. This
 * class (and a derived version of it) is to be passed to the rendering system
 * to be able to get the enum uniform.
 */
class UniformInterface {
 public:
   ...
   */
  virtual void SetValueFloat(const std::string& name,
   ...
   * @param size: The size of the vector.
   */
  virtual void SetValueInt(const std::string& name,
