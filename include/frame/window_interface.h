 ...
 * @brief Interface to a window this is specific to a platform (see Windows,
 * SDL, Linux, OSX, iOS, etc...).
 */
struct WindowInterface {
  ...
  /**
   * @brief Set the unique device (this is suppose to be variable to the one you
  ...
  /**
   * @brief Return the context to the window (this is a void* as this can be a
   ...
   */
  virtual void Resize(glm::uvec2 size, FullScreenEnum fullscreen_enum =
                                           FullScreenEnum::WINDOW) = 0;
  /**
