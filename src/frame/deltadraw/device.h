...
class Device : public DeviceInterface
{
  public:
    /**
     * @brief Constructor will initialize the Delta Draw context.
	 * @param sdl_context: A pointer to the SDL context.
     * @param size: Window size.
     */
    Device(void* sdl_context, glm::uvec2 size);
  ...
  public:
    ...
    {
        return RenderingAPIEnum::DELTADRAW;
    }
