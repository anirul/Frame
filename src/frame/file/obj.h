...
class ObjMesh {
 public:
  /**
   * @brief Constructor create an obj object from a list of vertex, indices and
   * materials.
   * @param points: Vector of vertices.
   * @param indices: Vector of indices as int.
   * @param material: Material id (watch out this is an  internal material not a
   * entity id type of material!).
   */
