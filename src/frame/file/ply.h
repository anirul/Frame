...
class Ply {
   public:
    /**
     * @brief Constructor create a Ply parser and parse the file into buffers.
   ...
   public:
     ...
     */
    const std::vector<glm::vec2>& GetTextureCoordinates() const { return texture_coordinates_; }
    /**
