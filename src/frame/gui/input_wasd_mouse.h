 ...
 * @brief This is where you can handle the input from keyboard and mouse to the
 * app (with wheel support). See the input interface class for more info.
 */
class InputWasdMouse : public InputInterface {
 public:
   ...
   * @param rotation_multiplication: Factor to change the mouse speed when in
   * movement mode.
   * @param translation_multiplication: Factor to change the mouse speed when in
   * translation mode.
   * @param wheel_multiplication: Factor to change the mouse wheel speed.
   */
  InputWasdMouse(DeviceInterface& device, float move_multiplication,
                 float rotation_multiplication,
                 float translation_multiplication, float wheel_multiplication)
      : device_(device),
