...
bool WindowResolution::DrawCallback() {
  ...
  if (ImGui::BeginCombo("Designation",
                        resolution_items_[resolution_selected_].c_str())) {
  ...
  if (ImGui::BeginCombo("Full screen",
                        fullscreen_items_[fullscreen_selected_].c_str())) {
  ...
  ImGui::Separator();
  if (ImGui::BeginCombo("Stereo selection",
                        stereo_items_[stereo_selected_].c_str())) {
  ...
  ImGui::DragFloat("Interocular distance", &interocular_distance_, 0.0f, 1.0f,
                   0.001f);
  ImGui::DragFloat3("Focus point", glm::value_ptr(focus_point_), 0.0f, 1000.0f,
                    0.1f);
