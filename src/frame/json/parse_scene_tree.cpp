            ...
            const SceneStaticMesh& proto_scene_static_mesh)
        {
            ...
            for (const auto node_mesh_id : vec_node_mesh_id) {
                ...
                mesh.SetRenderPrimitive(
                    proto_scene_static_mesh.render_primitive_enum());
                auto str =
                    fmt::format("{}.{}", proto_scene_static_mesh.name(), i);
                mesh.SetName(str);
