...
NodeLight::NodeLight(
    ...
    : NodeInterface(func), light_type_(NodeLightEnum::SPOT),
      position_(position), direction_(direction), color_(color),
      dot_inner_limit_(dot_inner_limit), dot_outer_limit_(dot_outer_limit)
{
}
