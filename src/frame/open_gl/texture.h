...
class Texture : public TextureInterface, public BindInterface {
   public:
    /**
     * @brief Create an empty texture of size size.
     ...
     */
    Texture(const std::pair<std::uint32_t, std::uint32_t> size,
    ...
    /**
     * @brief Create from a raw pointer.
     * @param size: Texture size in pixels.
     * @param pixel_element_size: Size of one of the element in a pixel (BYTE, SHORT, HALF, FLOAT).
     * @param pixel_element_structure: Structure of a pixel (R, RG, RGB, RGBA).
     */
    Texture(const std::pair<std::uint32_t, std::uint32_t> size, const void* data,
            const proto::PixelElementSize pixel_element_size = proto::PixelElementSize_BYTE(),
            const proto::PixelStructure pixel_structure      = proto::PixelStructure_RGB());
   ...
   protected:
     ...
     * @param pixel_element_structure: Structure of a pixel (R, RG, RGB, RGBA).
     */
    Texture(const proto::PixelElementSize pixel_element_size = proto::PixelElementSize_BYTE(),
            const proto::PixelStructure pixel_structure      = proto::PixelStructure_RGB())
