...
namespace frame::opengl::file {
    ...
    namespace {
            ...
            const frame::file::ObjMaterial& material_obj)
        {
            ...
            auto roughness_name =
                fmt::format("{}.Roughness", material_obj.name);
            ...
            int counter)
        {
            ...
            auto static_mesh =
                std::make_unique<opengl::StaticMesh>(level, parameter);
            ...
            const std::string& material_name /* = ""*/)
        {
            ...
            for (const auto& mesh : meshes) {
                ...
                auto func =
                    [&level](const std::string& name) -> NodeInterface* {
                ...
                auto ptr =
                    std::make_unique<NodeStaticMesh>(func, static_mesh_id);
