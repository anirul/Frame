...
/**
 * @class ScopedBind
 * @brief This is a simple kind of scoped lock similar technique to lock
 * underlying class as needed by RAII.
 */
class ScopedBind {
 public:
  /**
   * @brief Constructor this take a class and a slot and lock it for the
   * lifespan of current object in the RAII fashion.
