...
StaticMesh::StaticMesh(LevelInterface& level,
  ...
  if (color_buffer_id_) {
    ...
    glVertexAttribPointer(++vertex_array_count, color_buffer_size_, GL_FLOAT,
                          GL_FALSE, 0, nullptr);
  ...
  if (normal_buffer_id_) {
    ...
    glVertexAttribPointer(++vertex_array_count, normal_buffer_size_, GL_FLOAT,
                          GL_TRUE, 0, nullptr);
  ...
  if (texture_buffer_id_) {
    ...
    glVertexAttribPointer(++vertex_array_count, texture_buffer_size_, GL_FLOAT,
                          GL_FALSE, 0, nullptr);
