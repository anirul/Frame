...
class StaticMesh : public BindInterface, public StaticMeshInterface {
   ...
   public:
     ...
     */
    void SetIndexSize(std::size_t index_size) override { index_size_ = index_size; }
    /**
     ...
     */
    void SetRenderPrimitive(
        proto::SceneStaticMesh::RenderPrimitiveEnum render_primitive_enum) override {
     ...
     */
    proto::SceneStaticMesh::RenderPrimitiveEnum GetRenderPrimitive() const override {
