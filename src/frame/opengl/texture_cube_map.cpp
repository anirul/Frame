...
namespace frame::opengl {
    ...
    TextureCubeMap::TextureCubeMap(const TextureParameter& texture_parameter)
        : TextureCubeMap(texture_parameter.pixel_element_size,
            ...
            { nullptr, nullptr, nullptr, nullptr, nullptr, nullptr }*/)
    {
        ...
        for (unsigned int i : {0, 1, 2, 3, 4, 5}) {
            glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0,
                ...
                static_cast<GLsizei>(size_.x), static_cast<GLsizei>(size_.y),
                0, opengl::ConvertToGLType(pixel_structure_),
