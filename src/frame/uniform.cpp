...
glm::ivec2 Uniform::GetIVec2() const
{
#ifdef _DEBUG
    if (type_ != proto::Uniform::INT_VECTOR2)
    {
        throw std::runtime_error("Uniform is not a ivec2");
    }
    if (uniform_enum_ != proto::Uniform::INVALID_UNIFORM)
    {
        throw std::runtime_error("Uniform is not a ivec2");
    }
    if (value_int_.size() != 2)
    {
        throw std::runtime_error("Uniform is not a ivec2");
    }
#endif
    return glm::ivec2(value_int_[0], value_int_[1]);
}

glm::ivec3 Uniform::GetIVec3() const
{
#ifdef _DEBUG
    if (type_ != proto::Uniform::INT_VECTOR3)
    {
        throw std::runtime_error("Uniform is not a ivec3");
    }
    if (uniform_enum_ != proto::Uniform::INVALID_UNIFORM)
    {
        throw std::runtime_error("Uniform is not a ivec3");
    }
    if (value_int_.size() != 3)
    {
        throw std::runtime_error("Uniform is not a ivec3");
    }
#endif
    return glm::ivec3(value_int_[0], value_int_[1], value_int_[2]);
}

glm::ivec4 Uniform::GetIVec4() const
{
#ifdef _DEBUG
    if (type_ != proto::Uniform::INT_VECTOR4)
    {
        throw std::runtime_error("Uniform is not a ivec4");
    }
    if (uniform_enum_ != proto::Uniform::INVALID_UNIFORM)
    {
        throw std::runtime_error("Uniform is not a ivec4");
    }
    if (value_int_.size() != 4)
    {
        throw std::runtime_error("Uniform is not a ivec4");
    }
#endif
    return glm::ivec4(
        value_int_[0], value_int_[1], value_int_[2], value_int_[3]);
}

glm::mat2 Uniform::GetMat2() const
{
#ifdef _DEBUG
    if (type_ != proto::Uniform::FLOAT_MATRIX2)
    {
        throw std::runtime_error("Uniform is not a mat2");
    }
    if (uniform_enum_ != proto::Uniform::INVALID_UNIFORM)
    {
        throw std::runtime_error("Uniform is not a mat2");
...
glm::mat3 Uniform::GetMat3() const
{
#ifdef _DEBUG
    if (type_ != proto::Uniform::FLOAT_MATRIX3)
    {
        throw std::runtime_error("Uniform is not a mat3");
    }
    if (uniform_enum_ != proto::Uniform::INVALID_UNIFORM)
    {
        throw std::runtime_error("Uniform is not a mat3");
    }
    if (value_float_.size() != 9)
    {
        throw std::runtime_error("Uniform is not a mat3");
    }
#endif
