 ...
 * class is to be passed to the rendering system to be able to get the enum
 * uniform.
 */
class UniformWrapper : public UniformInterface {
 public:
   ...
   */
  UniformWrapper(const glm::mat4& projection, const glm::mat4& view,
                 const glm::mat4& model, double dt);
 ...
 public:
   ...
   * @param size: The size of the vector.
   */
  void SetValueInt(const std::string& name,
