...
TEST_F(ParsePixelTest, CompareSizeTest) {
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelElementSize_BYTE(),
                                         frame::proto::PixelElementSize_BYTE()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_BYTE(),
                                          frame::proto::PixelElementSize_SHORT()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_BYTE(),
                                          frame::proto::PixelElementSize_HALF()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_BYTE(),
                                          frame::proto::PixelElementSize_FLOAT()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelElementSize_SHORT(),
                                         frame::proto::PixelElementSize_SHORT()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_SHORT(),
                                          frame::proto::PixelElementSize_HALF()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_SHORT(),
                                          frame::proto::PixelElementSize_FLOAT()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelElementSize_HALF(),
                                         frame::proto::PixelElementSize_HALF()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelElementSize_HALF(),
                                          frame::proto::PixelElementSize_FLOAT()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelElementSize_FLOAT(),
                                         frame::proto::PixelElementSize_FLOAT()));
}
...
TEST_F(ParsePixelTest, CreateRGBTest) { EXPECT_EQ(3, frame::proto::PixelStructure_RGB().value()); }
...
TEST_F(ParsePixelTest, CompareStructureTest) {
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelStructure_GREY(),
                                         frame::proto::PixelStructure_GREY()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_GREY(),
                                          frame::proto::PixelStructure_GREY_ALPHA()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_GREY(),
                                          frame::proto::PixelStructure_RGB()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_GREY(),
                                          frame::proto::PixelStructure_RGB_ALPHA()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelStructure_GREY_ALPHA(),
                                         frame::proto::PixelStructure_GREY_ALPHA()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_GREY_ALPHA(),
                                          frame::proto::PixelStructure_RGB()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_GREY_ALPHA(),
                                          frame::proto::PixelStructure_RGB_ALPHA()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelStructure_RGB(),
                                         frame::proto::PixelStructure_RGB()));
    EXPECT_FALSE(frame::proto::operator==(frame::proto::PixelStructure_RGB(),
                                          frame::proto::PixelStructure_RGB_ALPHA()));
    EXPECT_TRUE(frame::proto::operator==(frame::proto::PixelStructure_RGB_ALPHA(),
                                         frame::proto::PixelStructure_RGB_ALPHA()));
}
