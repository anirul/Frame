...
TEST_F(PixelTest, ConvertToGLTypePixelElementPixelTest)
{
    ...
    EXPECT_EQ(
        GL_FLOAT,
        frame::opengl::ConvertToGLType(frame::proto::PixelElementSize_HALF()));
    EXPECT_EQ(
        GL_FLOAT,
        frame::opengl::ConvertToGLType(frame::proto::PixelElementSize_FLOAT()));
}
...
TEST_F(PixelTest, ConvertToGLTypePixelStructurePixelTest)
{
    EXPECT_EQ(
        GL_RED,
        frame::opengl::ConvertToGLType(frame::proto::PixelStructure_GREY()));
    EXPECT_EQ(
        GL_RG,
